/*function informeBoton(botonId,botonNombre,botonValor){
    ...
    const userMessege1 = "Id del Boton: " + botonId + "\n";
    //Informacion sobre el nombre del boton
    const userMessege2 = "Nombre del Boton: " + botonNombre + "\n";
    //el valor del boton
    const userMessege3 = "Valor del Boton: " + botonValor + "\n";

    const userMessege4 = "Valor del Boton: " + botonValor;
    alert(userMessege1 + userMessege2 + userMessege3 + userMessege4);
}*/

function toggleMenu() {//Menu de boton inicio
...
function toggleMenu2() {//Menu de boton noticias
    var menu = document.getElementById('desktop-menu2');
    if(menu.style.display === 'none') {
        menu.style.display = 'block';
    } else {
        menu.style.display = 'none';
...
function toggleMenu3() {//Menu de boton noticias
    var menu = document.getElementById('desktop-menu3');
    if(menu.style.display === 'none') {
        menu.style.display = 'block';
    } else {
        menu.style.display = 'none';
